            ...
            <div class="span9 with-sidebar">
                <div class="container">
                    ...
                    <div class="span12 field-box">
                        <?= Html::label('名称', null) . Html::textInput('description', '', ['class' => 'span9']) ?>
                    </div>
                    <div class="span12 field-box">
                        <?= Html::label('标识', null) . Html::textInput('name', '', ['class' => 'span9']) ?>
                    </div>
                    <div class="span12 field-box">
                        <?= Html::label('规则名称', null) . Html::textInput('rule_name', '', ['class' => 'span9']) ?>
                    </div>
                    <div class="span12 field-box">
                        <?= Html::label('数据', null) . Html::textarea('data', '', ['class' => 'span9']) ?>
                    </div>
