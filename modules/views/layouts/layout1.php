...
<html>
    <head>
        ...
        <?php $this->registerMetaTag(['viewport' => 'author', 'content' => 'width=device-width, initial-scale=1.0']); ?>
    ...
    <body>
        ...
        <div class="navbar navbar-inverse">
            <div class="navbar-inner">
                ...
                <a class="brand" href="<?= Url::to(['/index/index']) ?>" style="font-weight:700;font-family:Microsoft Yahei">慕课商城 - 后台管理</a>
